--custom CAN reading script for Molly EFI UAV
-- modified by RPM 02/07/24
...
local function engine_control(_driver, _idx)
    ...
    function self.update_telem_out()
       ...
       gcs:send_named_float('Manifold-temp[C]', tlm.mat_C)
       gcs:send_named_float('Head-temp[C]', tlm.cht)
       gcs:send_named_float('ECU-temp-C', tlm.ecu_temp)
       gcs:send_named_float('GEN-temp-C', tlm.gen_temp)
       gcs:send_named_float('Inlet-temp-C', tlm.inlet_temp)
       
       
       gcs:send_named_float('MAP_kPa', tlm.map_kPa)
       gcs:send_named_float('BARO_kPa', tlm.barometer_kPa)
       gcs:send_named_float('RPM', tlm.rpm)

       gcs:send_named_float('Fuel_KG', tlm.total_fuel_g)
       gcs:send_named_float('Fuel_rem_g', tlm.rem_fuel_g)

       gcs:send_named_float('THR-POS', tlm.thr_pos)
       gcs:send_named_float('DUCT-POS', tlm.duct_pos)
       gcs:send_named_float('THR-Source', tlm.thr_source)
